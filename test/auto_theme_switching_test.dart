...
void main() {
  ...
  group('Auto Theme Switching Tests', () {
    ...
    test('Theme variants should be correctly mapped', () {
      ...
      expect(AppSettings.getThemeVariant('tokyo-night', false),
          'tokyo-night-light');
      expect(
          AppSettings.getThemeVariant('tokyo-night', true), 'tokyo-night-dark');
    });
    ...
    test('Auto theme switching should work in system mode', () async {
      ...
      // Set a theme pair
      settings.themeName =
          'github'; // This should stay as 'github' in light mode
    ...
    test('Theme switching should preserve theme family when possible',
        () async {
      // Set to system mode
      settings.themeMode = ThemeModeOption.system;
