...
void main() {
  group('Real-Time Shared Content Tests', () {
    ...
    test('Should convert URL type with file path to file type in real-time', () async {
      ...
      expect(SharingService.isFilePath(urlWithFilePath['content'] as String), true);
      
      // Verify file name can be extracted
      final fileName = SharedContentManager.extractFileNameFromPath(urlWithFilePath['content'] as String);
    ...
    test('Should handle complex iOS file paths in real-time', () async {
      ...
      final iosFileData = {
        ...
        'content': 'file:///Users/wouter/Library/Developer/CoreSimulator/Devices/2C19D11B-BEF5-45B1-81FD-0919B6BFB505/data/Containers/Data/Application/DDE7D1D9-790B-429E-A07B-BCAE79AADB4F/tmp/info.wouter.sourceviewer-Inbox/sample.py'
      };
      ...
      final fileName = SharedContentManager.extractFileNameFromPath(iosFileData['content'] as String);
    ...
    test('Should handle URL sharing in real-time', () async {
      ...
      expect(SharingService.isFilePath(urlSharedData['content'] as String), false);
    });

    test('Should handle text sharing in real-time', () async {
      // Test text sharing
      final textSharedData = {
        'type': 'text',
        'content': 'Hello World'
      };
