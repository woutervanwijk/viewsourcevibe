...
void main() {
  group('Manual Theme Preservation with System Dark Mode Changes', () {
    ...
    test(
        'Manual theme selection should not auto-switch when system dark mode changes',
        () async {
      ...
      settings.themeName =
          'monokai'; // This should set _preserveManualThemeSelection = true
      ...
      expect(settings.themeName, 'monokai',
          reason:
              'Manual theme should be preserved when system dark mode changes');
      ...
      expect(settings.themeName, 'monokai',
          reason:
              'Manual theme should be preserved when system dark mode changes back');
    });

    test('Theme pair should auto-switch when system dark mode changes',
        () async {
      // Start with system theme mode
      settings.themeMode = ThemeModeOption.system;
      ...
      settings.themeName =
          'github'; // This should set _preserveManualThemeSelection = false
      ...
      expect(settings.themeName, 'github-dark',
          reason: 'Theme pair should auto-switch to dark variant');
      ...
      expect(settings.themeName, 'github',
          reason: 'Theme pair should auto-switch back to light variant');
    });

    test('Manual theme selection should persist across theme mode changes',
        () async {
      // Select a manual theme
      settings.themeName =
          'vs'; // This should set _preserveManualThemeSelection = true
      ...
      expect(settings.themeName, 'vs',
          reason:
              'Manual theme should be preserved when theme mode changes to dark');
      ...
      expect(settings.themeName, 'vs',
          reason:
              'Manual theme should be preserved when theme mode changes to light');
      ...
      expect(settings.themeName, 'vs',
          reason:
              'Manual theme should be preserved when theme mode changes back to system');
    });

    test(
        'Switching from manual theme to theme pair should enable auto-switching',
        () async {
      // Select a manual theme
      settings.themeName =
          'monokai'; // This should set _preserveManualThemeSelection = true
      ...
      expect(settings.themeName, 'github-dark',
          reason:
              'Theme pair should auto-switch after switching from manual theme');
    });
    ...
    test('Multiple manual theme changes should all be preserved', () async {
      ...
      settings.darkMode = true;
      expect(settings.themeName, 'vs',
          reason: 'First manual theme should be preserved');
      ...
      settings.darkMode = false;
      expect(settings.themeName, 'monokai',
          reason: 'Second manual theme should be preserved');
      ...
      settings.darkMode = true;
      expect(settings.themeName, 'nord',
          reason: 'Third manual theme should be preserved');
    });
  });
}
