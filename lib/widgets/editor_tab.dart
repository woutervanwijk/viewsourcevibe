...
class _EditorTabState extends State<EditorTab> with AutomaticKeepAliveClientMixin {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    final currentContentHash = '${currentContent.hashCode}_${widget.file.extension}_${widget.settings.fontSize}_'
    ...
    return FutureBuilder<Widget>(
      future: MonacoSourceViewerEditor.buildEditor(
        ...
        horizontalController: widget.htmlService.isBeautifyEnabled
            ? widget.htmlService.horizontalScrollController
            : null,
        ...
        onFindControllerChanged: (controller) => widget.htmlService.updateActiveFindController(controller),
